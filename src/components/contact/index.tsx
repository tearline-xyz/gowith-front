const Contact = () => {
  return (
    <div id="contact" className="mt-[20.8rem] mb-[26.8rem] font-alexandria">
      ...
      <div
        className="flex items-center gap-[5.28rem] justify-center"
        animation-button=""
      >
        <div className="h-[13.3rem] rounded-full bg-gradient-to-r from-[#e3f2ea]  from-[21.2%] to-[rgba(14,166,94,0)] to-[54.7%] [--tw-gradient-angle:96deg] flex items-center justify-center w-[50rem]">
        ...
        <div className="flex gap-[1.59rem] items-center" animation-button="">
          <img
